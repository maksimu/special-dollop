...
def test_logger_initialization():
    ...
    result = keeper_pam_connections.initialize_logger(
...
def test_verbose_flag_toggling():
    ...
    # Toggle off
    keeper_pam_connections.set_verbose_logging(False)
    print("✅ Set verbose=False succeeded")

    # Toggle on
    keeper_pam_connections.set_verbose_logging(True)
...
def test_logger_functions_exist():
    ...
    assert hasattr(keeper_pam_connections, 'initialize_logger'), \
        "initialize_logger should be exported"
    assert hasattr(keeper_pam_connections, 'set_verbose_logging'), \
        "set_verbose_logging should be exported"

    # Verify they're callable
    assert callable(keeper_pam_connections.initialize_logger), \
        "initialize_logger should be callable"
    assert callable(keeper_pam_connections.set_verbose_logging), \
