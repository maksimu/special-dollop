...
fn test_router_url_prod_govcloud() {
    ...
    let ksm_config = r#"{"hostname": "govcloud.keepersecurity.us", "clientId": "test", "privateKey": "test"}"#;
...
fn test_router_url_commercial() {
    ...
    let ksm_config = r#"{"hostname": "keepersecurity.com", "clientId": "test", "privateKey": "test"}"#;
    let result = router_url_from_ksm_config(ksm_config).unwrap();
...
fn test_router_url_commercial_dev() {
    ...
    let ksm_config = r#"{"hostname": "dev.keepersecurity.com", "clientId": "test", "privateKey": "test"}"#;
    let result = router_url_from_ksm_config(ksm_config).unwrap();
